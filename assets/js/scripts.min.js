...
(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "sd-"; /* jshint -W109 */ // Prefix string to be prepended to the cart's name in the session storage
			...
			this.paypalCurrency = "US"; // PayPal's currency code
			this.paypalBusinessEmail = "tim.smith.hdg@gmail.com"; // Your Business PayPal's account email address
		...
		displayUserDetails: function() {
			if( this.$userDetails.length ) {
				if( this.storage.getItem( "shipping-name" ) === null ) {
					...
					html += "<h2>Billing and Shipping</h2>"; /* jshint -W015 */
					html += "<ul>";
					html += "<li>" + name + "</li>";
					html += "<li>" + email + "</li>";
					html += "<li>" + city + "</li>";
		...
		updateCart: function() {
		  ...
		  if( self.$updateCartBtn.length ) {
			self.$updateCartBtn.on( "click", function() {
				...
				var cart = self.storage.getItem( self.cartName ); /* jshint -W098 */
...
(function ($, window, document, undefined) {
  ...
  $(function () {
    ...
    $('#navLearn').click( function() {
      ...
      $('#infoLearn').css('display', 'block');
    });
    $('#navPlay').click( function() {
      $('#main').children().css('display', 'none');
      $('#info').children().css('display', 'none');
      $('#play').css('display', 'block');
      $('#infoPlay').css('display', 'block');
    });
    $('#navLearnLink').click( function() {
      $('#main').children().css('display', 'none');
      $('#info').children().css('display', 'none');
      $('#learn').css('display', 'block');
      $('#infoLearn').css('display', 'block');
    });
    $('#navPlayLink').click( function() {
      $('#main').children().css('display', 'none');
      $('#info').children().css('display', 'none');
      $('#play').css('display', 'block');
      $('#infoPlay').css('display', 'block');
    ...
    $('#navCode').click( function() {
      ...
      $('#infoCode').css('display', 'block');
    });

    $('a[href^="#"]').click(function(event) {
      var id = $(this).attr('href');
      var target = ($(id).offset().top - 85);
    ...
    $(window).scroll(function() {
      if($(this).scrollTop() > offset) {
        ...
        $('nav').addClass('isSmall');
        $('nav').removeClass('mainNav');
        $('nav').removeClass('resumeNav');
      } else {
        $('nav').removeClass('isFixed');
        $('nav').removeClass('isSmall');
        $('nav').addClass('mainNav');
        $('nav').addClass('resumeNav');
      }
    });
  });
